...
class _SettingsMain extends State<SettingsMain> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    initAsync(() async {
      print(await uiSettingsManager.getStringNullable(StorageKey.setman_gitCommitSigningKey));
    });
  }
                                          ...
                                          child: TextButton.icon(
                                            onPressed: () async {
                                              await ImportPrivKeyDialog.showDialog(context, ((String, String) sshCredentials) async {
                                                await uiSettingsManager.setStringNullable(StorageKey.setman_gitCommitSigningKey, sshCredentials.$2);
