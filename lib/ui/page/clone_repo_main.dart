...
class _CloneRepoMain extends State<CloneRepoMain> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    initAsync(() async {
      ...
      gitProviderManager.getRepos(accessToken, addRepos, (callback) => loadNextRepos = callback);
    });
  }
  ...
  void cloneRepository(String repoUrl) {
    SelectFolderDialog.showDialog(context, () async {
      ...
      final isEmpty = await useDirectory(selectedDirectory, (bookmarkPath) async => await uiSettingsManager.setGitDirPath(bookmarkPath), (
        selectedDirectory,
      ) async {
                                ...
                                return Container(
                                  ...
                                  child: TextButton.icon(
                                    ...
                                    style: ButtonStyle(
                                      ...
                                      padding: WidgetStatePropertyAll(EdgeInsets.only(right: spaceMD, top: spaceSM, bottom: spaceSM, left: spaceXS)),
                  ...
                  IntrinsicHeight(
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton.icon(
                          onPressed:
                              cloneUrlController.text.isEmpty
                                  ? null
                                  : () async {
