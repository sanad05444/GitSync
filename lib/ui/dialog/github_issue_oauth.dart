    ...
    builder:
        (BuildContext context) => BaseAlertDialog(
          ...
          title: SizedBox(
            ...
            child: Text(t.githubIssueOauthTitle, style: TextStyle(color: primaryLight, fontSize: textXL, fontWeight: FontWeight.bold)),
          ),
          content: SingleChildScrollView(
            child: ListBody(
              children: [Text(t.githubIssueOauthMsg, style: const TextStyle(color: primaryLight, fontWeight: FontWeight.bold, fontSize: textSM))],
            ),
          ),
          actions: <Widget>[
            TextButton(
            ...
            TextButton.icon(
              ...
              label: Text(t.oauth.toUpperCase(), style: TextStyle(color: secondaryDark, fontSize: textMD, fontWeight: FontWeight.bold)),
              style: ButtonStyle(
