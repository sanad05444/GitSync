...
Future<void> showDialog(
  ...
  Set<String>? prevSelectedApplications,
) async {
  final List<String> selectedApplications =
      prevSelectedApplications?.toList() ?? [];
            ...
            children: [
              ...
              FutureBuilder(
                future: AsyncMemoizer().runOnce(
                  () => AccessibilityServiceHelper.getDeviceApplications(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return Stack(
                                ...
                                children: [
                                  TextButton(
                                    onPressed: () {
                                      if (selectedApplications.contains(
                                        packageName,
                                      )) {
        ...
        TextButton(
          ...
          onPressed: () async {
            uiSettingsManager.setStringList(
              StorageKey.setman_packageNames,
              selectedApplications,
            );
            Navigator.of(context).canPop() ? Navigator.pop(context) : null;
          },
