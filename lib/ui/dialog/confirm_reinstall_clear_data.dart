        ...
        (BuildContext context) => PopScope(
          ...
          child: BaseAlertDialog(
            title: SizedBox(
              ...
              child: Text(t.iosClearDataTitle, style: TextStyle(color: primaryLight, fontSize: textXL, fontWeight: FontWeight.bold)),
            ),
            content: SingleChildScrollView(
              child: ListBody(
                children: [
                  Text(t.iosClearDataMsg, style: const TextStyle(color: primaryLight, fontWeight: FontWeight.bold, fontSize: textSM)),
            ...
            actions: <Widget>[
              ...
              TextButton(
                child: Text(t.skip.toUpperCase(), style: TextStyle(color: primaryLight, fontSize: textMD)),
                onPressed: () {
                  Navigator.of(context).canPop() ? Navigator.pop(context) : null;
                },
              ),
