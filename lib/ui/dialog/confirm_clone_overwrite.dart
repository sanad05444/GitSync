        ...
        (BuildContext context) => PopScope(
          ...
          child: BaseAlertDialog(
            title: SizedBox(
              ...
              child: Text(t.confirmCloneOverwriteTitle, style: TextStyle(color: primaryLight, fontSize: textXL, fontWeight: FontWeight.bold)),
            ),
            content: SingleChildScrollView(
              child: ListBody(
                children: [
                  Text(t.confirmCloneOverwriteMsg, style: const TextStyle(color: primaryLight, fontWeight: FontWeight.bold, fontSize: textSM)),
              ...
              StatefulBuilder(
                builder:
                    (context, setState) => TextButton.icon(
                      label: Text(t.confirmCloneOverwriteAction.toUpperCase(), style: TextStyle(color: tertiaryNegative, fontSize: textMD)),
