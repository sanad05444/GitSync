          ...
          child: StatefulBuilder(
            builder: (context, setState) {
              ...
              return FutureBuilder(
                ...
                builder:
                    (context, snapshot) => BaseAlertDialog(
                      expandable: true,
                      title: SizedBox(
                                                    ...
                                                    TextButton.icon(
                                                      onPressed: () {
                                                        if (selectedFiles.isNotEmpty) {
                                                          ...
                                                          selectedFiles.clear();
                                                          selectedFiles.addAll(snapshot.data?.map((item) => item.$1).toList() ?? []);
                                                        }
                                                      ...
                                                      icon: FaIcon(
                                                        selectedFiles.length == snapshot.data?.length
                                              ...
                                              Expanded(
                                                child: AnimatedListView(
                                                  ...
                                                  itemBuilder: (context, index) {
                                                    final fileName = snapshot.data![index].$1;
                                                    final fileType = snapshot.data![index].$2;

                                                    (IconData, Color) infoIcon = (FontAwesomeIcons.solidSquarePlus, tertiaryPositive);
                                                    switch (fileType) {
                                                      case 1:
                                                        {
                                                          infoIcon = (FontAwesomeIcons.squarePen, tertiaryWarning);
                                                          break;
                                                        }
                                                      case 2:
                                                        {
                                                          infoIcon = (FontAwesomeIcons.solidSquareMinus, tertiaryNegative);
                                                          break;
                                                        }
                                                      case 3:
                                                        {
                                                          infoIcon = (FontAwesomeIcons.solidSquarePlus, tertiaryPositive);
                                                          break;
                                                        }
                                                    }
                                                    ...
                                                    return TextButton(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                FaIcon(
                                                                  ...
                                                                  color: selectedFiles.contains(fileName) ? secondaryInfo : tertiaryInfo,
                                                                  size: textMD,
                                                                ),
                                                                ...
                                                                Flexible(
                                                                  child: ExtendedText(
                                                                    ...
                                                                    overflowWidget: TextOverflowWidget(
                                                                      ...
                                                                      child: Text("…", style: TextStyle(color: tertiaryLight, fontSize: textMD)),
                                                                    ),
                                                          ...
                                                          FaIcon(infoIcon.$1, color: infoIcon.$2, size: textMD),
                                                        ],
                                                      ),
                                                    );
                                                  },
                          ...
                          children: [
                            uploading
                                ...
                                : IconButton(
                                  ...
                                  style: ButtonStyle(
                                    alignment: Alignment.center,
                                    backgroundColor: WidgetStatePropertyAll(selectedFiles.isNotEmpty ? secondaryNegative : tertiaryDark),
                                  ...
                                  icon: FaIcon(FontAwesomeIcons.eraser, color: selectedFiles.isNotEmpty ? primaryLight : tertiaryLight, size: textMD),
                                ),
                            TextButton.icon(
                              onPressed:
                                  selectedFiles.isNotEmpty
