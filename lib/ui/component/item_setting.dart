...
class ItemSetting extends StatefulWidget {
  const ItemSetting({super.key, required this.title, required this.getFn, required this.setFn, this.description, this.hint, this.maxLines = 1, this.minLines = 1, this.isTextArea = false});
...
class _ItemSetting extends State<ItemSetting> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Padding(padding: EdgeInsets.symmetric(horizontal: spaceMD), child: Text(widget.title.toUpperCase(), style: TextStyle(color: primaryLight, fontSize: textMD, fontWeight: FontWeight.bold))),
        widget.description == null
            ? SizedBox.shrink()
            : Padding(
              padding: EdgeInsets.symmetric(horizontal: spaceMD),
              child: Text(widget.description ?? "", style: TextStyle(color: secondaryLight, fontSize: textSM, fontWeight: FontWeight.bold)),
            ),
              ...
              child: SingleChildScrollView(
                ...
                child: ConstrainedBox(
                  ...
                  child: TextField(
                    ...
                    style: TextStyle(color: primaryLight, fontWeight: FontWeight.bold, decoration: TextDecoration.none, decorationThickness: 0, fontSize: textMD),
