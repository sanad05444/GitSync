    ...
    return Container(
      ...
      child: FutureBuilder(
        future: uiSettingsManager.getBool(
          StorageKey.setman_scheduledSyncSettingsExpanded,
        ),
            ...
            AnimatedSize(
              ...
              child: Container(
                ...
                child: (snapshot.data ?? false)
                    ? FutureBuilder(
                        future: (() async {
                          final parts = (await uiSettingsManager.getString(
                            StorageKey.setman_schedule,
                          )).split("|");
