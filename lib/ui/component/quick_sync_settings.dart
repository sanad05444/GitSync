                          ...
                          (snapshot.data ?? false)
                              ? [
                                ...
                                TextButton.icon(
                                  onPressed: () async {
                                    await repoManager.setInt(
                                      StorageKey.repoman_shortcutSyncIndex,
                                      await repoManager.getInt(StorageKey.repoman_repoIndex),
                                    );
                                    setState(() {});
                                  },
                                  ...
                                  label: SizedBox(
                                    width: double.infinity,
                                    child: Text(t.useForShortcutSync, style: TextStyle(color: primaryLight, fontSize: textMD)),
                                  ),
                                ),
                                TextButton.icon(
                                  onPressed: () async {
                                  ...
                                  label: SizedBox(
                                    width: double.infinity,
                                    child: Text(t.useForShortcutManualSync, style: TextStyle(color: primaryLight, fontSize: textMD)),
                                  ),
                                ),
                                TextButton.icon(
                                  onPressed: () async {
                                    await repoManager.setInt(
                                      StorageKey.repoman_widgetSyncIndex,
                                      await repoManager.getInt(StorageKey.repoman_repoIndex),
                                    );
                                    setState(() {});
                                  },
                                  ...
                                  label: SizedBox(
                                    width: double.infinity,
                                    child: Text(t.useForWidgetSync, style: TextStyle(color: primaryLight, fontSize: textMD)),
                                  ),
                                ),
                                TextButton.icon(
                                  onPressed: () async {
                                  ...
                                  label: SizedBox(
                                    width: double.infinity,
                                    child: Text(t.useForWidgetManualSync, style: TextStyle(color: primaryLight, fontSize: textMD)),
                                  ),
                                ),
                              ]
                              : [],
