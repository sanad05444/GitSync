...
const String operationInProgressError =
    "Background operation in progress. Please try again later.";
const String networkUnavailable = "Network unavailable!";
const String invalidIndexHeaderError =
    "Invalid index data! Incorrect header signature detected.";
const String invalidDataInIndexInvalidEntry =
    "invalid data in index - invalid entry";
const String invalidDataInIndexExtensionIsTruncated =
    "invalid data in index - extension is truncated";
const String theIndexIsLocked = "the index is locked";
const String corruptedLooseFetchHead =
    "corrupted loose reference file: FETCH_HEAD";
const String missingAuthorDetailsError =
    "Missing repository author details. Please set your name and email in the repository settings.";
const String authMethodMismatchError =
...
const String rejectedNodeleteException =
...
const String rejectionWithReasonException =
...
const String mergeConflictNotificationBody =
    "There is an irreconcilable difference between the local and remote changes";
...
const String privacyPolicyLink =
    "https://gitsync.viscouspotenti.al/wiki/privacy-policy/";
const String eulaLink =
    "https://www.apple.com/legal/internet-services/itunes/dev/stdeula/";
const String githubDiscussionsLink =
    "https://github.com/ViscousPot/GitSync/discussions";
const String multiRepoDocsLink =
    "https://gitsync.viscouspotenti.al/wiki/multi-repo-support";
const String scheduledSyncDocsLink =
    "https://gitsync.viscouspotenti.al/wiki/sync-options/background/scheduled";
const String autoSyncDocsLink =
    "https://gitsync.viscouspotenti.al/wiki/sync-options/background/app-based";
const String tileSyncDocsLink =
    "https://gitsync.viscouspotenti.al/wiki/sync-options/background/quick-tile";
...
const String syncOptionsDocsLink =
    "https://gitsync.viscouspotenti.al/wiki/sync-options";
const String syncOptionsBGDocsLink =
    "https://gitsync.viscouspotenti.al/wiki/sync-options/background";
const String githubFeatureTemplate =
    "https://github.com/ViscousPot/GitSync/issues/new?template=FEATURE_REQUEST.yaml";
const String contributeLink =
    "https://github.com/sponsors/ViscousPot?sponsor=ViscousPot&frequency=one-time&amount=15";
